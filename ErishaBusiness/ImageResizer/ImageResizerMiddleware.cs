...
using ErishaBusiness.ImageResizer.Funcs;
using Newtonsoft.Json;
using ErishaBusiness.ImageResizer.Models;
using Microsoft.Extensions.FileProviders;

namespace ErishaBusiness.ImageResizer
{
    public class ImageResizerMiddleware
    {
        ...
        private SKData GetImageData(string imagePath, ResizeParams resizeParams, DateTime lastWriteTimeUtc)
        {
            ...
            using (var fs = File.OpenRead(imagePath))
            {
                ...
                var encodeFormat = resizeParams.format == "png" ? SKEncodedImageFormat.Jpeg : SKEncodedImageFormat.Jpeg;
