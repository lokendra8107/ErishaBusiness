...
namespace ErishaBusiness.Core
{
    ...
    public static class Extensions
    {
        ...
        public static Dictionary<string, int> EnumToDictionaryWithDescription<t>()
        {
        ...
        public static DateTime? ToDateTime(this string str, bool isWithTime = false)
        {
            ...
            string[] formats = { "dd/MM/yyyy", "d/MM/yyyy", "dd/M/yyyy", "dd/MM/yyyy h:mm:ss tt", "d/MM/yyyy h:mm:ss tt", "dd/M/yyyy h:mm:ss tt", 
                "yyyy-MM-dd", "yyyy-M-dd", "yyyy-MM-d", "yyyy-MM-dd h:mm:ss tt", "yyyy-M-dd h:mm:ss tt", "yyyy-MM-d h:mm:ss tt", "dd-MM-yyyy", 
                "d-MM-yyyy", "dd-M-yyyy", "d-M-yyyy", "M-d-yyyy", "dd-MM-yyyy h:mm:ss tt", "d-MM-yyyy h:mm:ss tt", 
                "dd-M-yyyy h:mm:ss tt", "yyyy/MM/dd", "yyyy/M/dd", "yyyy/MM/d", "yyyy/MM/dd  h:mm:ss tt", "yyyy/M/dd  h:mm:ss tt", "yyyy/MM/d  h:mm:ss tt", 
                "d/M/yyyy h:mm:ss tt", "M/dd/yyyy h:mm:ss tt", "MM/dd/yyyy h:mm:ss tt", "MM/d/yyyy h:mm:ss tt", "M/dd/yyyy", "MM/dd/yyyy", "MM/d/yyyy", "yyyyMMdd", 
                "d/M/yy", "dd-MM-yyyy HH:mm:ss", "M/dd/yyyy HH:mm:ss", "MM/dd/yyyy HH:mm:ss", "M/d/yyyy HH:mm:ss", "d/M/yyyy HH:mm:ss", "d/MM/yyyy HH:mm:ss", 
                "dd/M/yyyy HH:mm:ss","dd-MM-yyyy HH:mm","MM-dd-yyyy HH:mm" };
